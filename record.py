...
from utils import Screenshot, XboxController, KeyboardController
...
class MainWindow():
    ...
    def create_main_panel(self):
        ...
        self.outputDirStrVar.set("samples/luigi")
    ...
    def start_recording(self):
        ...
        if not self.outputDirStrVar.get():
            ...
            self.outputDir = os.path.join(os.getcwd(), self.outputDirStrVar.get())
...
def main():
    ...
    app = MainWindow(args.controller)
